...
{LEDService::LED_SERVICE_UUID,ADCService::ADC_SERVICE_UUID, AccelService::AccelService_UUID, MagService::MagService_UUID};
...
int main(void)
{
    ...
    while (true) {
        ...
        //MagServicePtr->updateMagValue(MagResult);
    }
}
